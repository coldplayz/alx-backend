...
app.get('/process', (req, res) => {
  ...
  // processor logic that handles reserve_seat jobs
  processorQueue.process('reserve_seat' /* concurrency */, (job, done) => {
    // for each job...
    getCurrentAvailableSeats().then((availableSeats) => {
      ...
      if (newAvailable >= 0) {
        ...
        // available seats is sub-zero;
        // should not get to this point because of reservationEnabled flag
